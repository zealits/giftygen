...
import GiftyGenLogo from "../../assets/giftygen_logo_1.png";
  ...
  return (
    <div className={`sidebar ${isOpen ? "open" : ""}`}>
      <div className="logo-details">
        {isOpen && (
          <img src={GiftyGenLogo} alt="GiftyGen Logo" className="logo-image" />
        )}
      ...
      <ul className="nav-list">
        ...
        <li className={`giftcards-menu-item ${isGiftCardsActive() ? "active-parent" : ""}`}>
          ...
          >
            ...
            {isOpen && (
              <span className="dropdown-arrow">{giftcardsDropdownOpen ? <FaChevronUp /> : <FaChevronDown />}</span>
            )}
        ...
        <li className={`settings-menu-item ${isSettingsActive() ? "active-parent" : ""}`}>
          ...
          >
            ...
            {isOpen && (
              <span className="dropdown-arrow">{settingsDropdownOpen ? <FaChevronUp /> : <FaChevronDown />}</span>
            )}
