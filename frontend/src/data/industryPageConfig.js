...
export const INDUSTRY_PAGE_CONFIG = {
  "Restaurant And Fine Dining": {
    ...
    ratingPrimaryPlaceholder: "e.g. 4.8★",
    ratingPrimaryCountPlaceholder: "e.g. 428 Dining Ratings",
    ratingSecondaryPlaceholder: "e.g. 4.6★",
    ratingSecondaryCountPlaceholder: "e.g. 156 Gift Card Reviews",
  ...
  "Hotels & Resorts": {
    ...
    ratingPrimaryPlaceholder: "e.g. 4.8★",
    ratingPrimaryCountPlaceholder: "e.g. 320 Stay Reviews",
    ratingSecondaryPlaceholder: "e.g. 4.6★",
    ratingSecondaryCountPlaceholder: "e.g. 89 Gift Card Reviews",
  ...
  "Fitness and Wellness memberships": {
    ...
    ratingPrimaryPlaceholder: "e.g. 4.8★",
    ratingPrimaryCountPlaceholder: "e.g. 156 Member Ratings",
    ratingSecondaryPlaceholder: "e.g. 4.6★",
    ratingSecondaryCountPlaceholder: "e.g. 42 Gift Card Reviews",
  ...
  "Retail & E-commerce": {
    ...
    ratingPrimaryPlaceholder: "e.g. 4.8★",
    ratingPrimaryCountPlaceholder: "e.g. 520 Product Ratings",
    ratingSecondaryPlaceholder: "e.g. 4.6★",
    ratingSecondaryCountPlaceholder: "e.g. 98 Gift Card Reviews",
  ...
  "Beauty and Personal care": {
    ...
    ratingPrimaryPlaceholder: "e.g. 4.8★",
    ratingPrimaryCountPlaceholder: "e.g. 245 Service Ratings",
    ratingSecondaryPlaceholder: "e.g. 4.6★",
    ratingSecondaryCountPlaceholder: "e.g. 67 Gift Card Reviews",
  ...
  "Seasonal Gifting": {
    ...
    ratingPrimaryPlaceholder: "e.g. 4.8★",
    ratingPrimaryCountPlaceholder: "e.g. 180 Gifting Reviews",
    ratingSecondaryPlaceholder: "e.g. 4.6★",
    ratingSecondaryCountPlaceholder: "e.g. 55 Redemption Reviews",
